...
var types = [
    {type: "success", svg: "/Team11/icons/notif-icon-success.svg"},
    {type: "warning", svg: "/Team11/icons/notif-icon-warning.svg"},
    {type: "danger",  svg: "/Team11/icons/notif-icon-danger.svg"},
    {type: "info",    svg: "/Team11/icons/notif-icon-info.svg"},
    {type: "message", svg: "/Team11/icons/notif-icon-message.svg"}
];
